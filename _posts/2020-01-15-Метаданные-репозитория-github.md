---
title: Метаданные репозитория github
---
...
For example, to list a project’s name, you might write something like The project is called github-metadata or to list an organization’s open source repositories, you might use the following:
